...
{
    Designed, prototyped, and implemented new algorithms to increase the efficiency of 6RS's products, reporting directly to the CTO;
    released a new routing algorithm to decrease travel distances by up to 15\%, with the potential to save customers up to \$10M per year across the entire fleet;
...
\cventry{Jan 2020\\Sep 2016}{Research Assistant}{Imperial College London}{London, UK}{}
{
    ...
    developed cross fields\ifnum\value{npages}>1
        \ in \inref{sec:software}{NekMesh}\fi
    \ to automate the generation of quadrilateral block-structured, high-order meshes;
