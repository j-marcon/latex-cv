\vbox{
\section{Experience}
\cventry{present\\Aug 2022}{Computational Meshing Engineer}{Luminary Cloud}{Redwood City, CA, USA}{}
{
    Contributing to the simulation platform in terms of CAD repair, and mesh generation and adaptation.
}
}
...
\cventry{Jan 2022\\Jan 2020}{Postdoctoral Fellow}{NASA Ames Research Center}{Moffett Field, CA, USA}{}
{
    ...
    implemented an adjoint elasticity solver to optimise high-order mesh deformations;
...
\cventry{Jan 2020\\Sep 2016}{Research Assistant}{Imperial College London}{London, UK}{}
{
    ...
    implemented cross fields to automate the generation of quadrilateral block-structured, high-order meshes;
...
\cventry{Jul 2016\\Sep 2015}{Development \& Applications Engineer}{Open Engineering}{Liège, Belgium}{}
{
    ...
    implemented multi-harmonic simulations;
